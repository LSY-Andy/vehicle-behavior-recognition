...
def parse_args():
    ...
    parser.add_argument(
        '--label-map', default='tools/data/ava/label_map2.txt', help='label map file')
    parser.add_argument(
...
def main():
    ...
    # camera = cv2.VideoCapture('/home/Custom-ava-dataset_Custom-Spatio-Temporally-Action-Video-Dataset/Dataset/video_crop/1.mp4')
