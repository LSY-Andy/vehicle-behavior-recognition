...
attributes_dict = {
#                    '1':dict(aname='body', type=2, options={'0':'stand',
#                    '1':'sit'},default_option_id="", anchor_id = 'FILE1_Z0_XY1'),

                   '1': dict(aname='body', type=2, options={'0':'stand',
                   '1':'tilt', '2':'fall'}, default_option_id="", anchor_id='FILE1_Z0_XY1'),
    
                   '2': dict(aname='status', type=2, options={'0':'run',
                   '1':'stop', '2':'knock'}, default_option_id="", anchor_id='FILE1_Z0_XY1'),
                   
#                   '2':dict(aname='action', type=2, options={'0':'walk',
#                    '1':'ride_safe','2':'ride_danger'},default_option_id="", anchor_id = 'FILE1_Z0_XY1'),
                  }
...
len_x = {}
for i in info:
    temp_dirname = i.split(',')[0] ##指到“，”之前的部分切片 0表示之前 如果是1 表示之后   
