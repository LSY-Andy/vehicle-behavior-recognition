...
#     parser.add_argument('--deep_sort_weights', type=str, default='deep_sort_pytorch/deep_sort/deep/checkpoint/best.pt', help='best.pt path')
    ...
    parser.add_argument('--classes', nargs='+', type=int, help='filter by class: --class 1, or --class 3')
